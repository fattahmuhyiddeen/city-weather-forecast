...
class App extends React.PureComponent {
  componentDidMount() {
    Keyboard.addListener(Platform.OS === 'ios' ? 'keyboardWillShow' : 'keyboardDidShow', this.onKeyboardAppear);
    Keyboard.addListener(Platform.OS === 'ios' ? 'keyboardWillHide' : 'keyboardDidHide', this.onKeyboardHide);
  ...
  onKeyboardAppear = e =>
    deviceActions.setKeyboard({ isKeyboardAppear: true, keyboardHeight: e.endCoordinates.height });
